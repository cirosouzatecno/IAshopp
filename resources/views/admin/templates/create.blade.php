                ...
                <form method="POST" action="{{ route('admin.templates.store') }}" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="language" name="language" type="text" class="mt-1 block w-full" value="{{ old('language', 'pt_BR') }}" required />
                    ...
                    <div>
                        ...
                        <textarea id="content" name="content" class="mt-1 block w-full rounded-md border-gray-300" rows="4">{{ old('content') }}</textarea>
